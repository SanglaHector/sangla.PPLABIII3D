...
{
    objeto.transaccion = transaccionDeForm(objeto.transaccion);
...
{
    transaccionDeServer(objeto.transaccion);
...
function transaccionDeForm(transaccionNode)
{
...
export {formatearParaServer,formatearParaForm,precioDeServer,transaccionDeServer}